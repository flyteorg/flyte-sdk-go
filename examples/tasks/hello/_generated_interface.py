...
DESCRIPTORS = [{'flyte_interface_version': 1, 'task': 'my_task', 'inputs': [{'name': 'x', 'type': 'integer', 'required': True}, {'name': 'label', 'type': 'string', 'required': True}], 'outputs': [{'name': 'o0', 'type': 'string'}]}]
